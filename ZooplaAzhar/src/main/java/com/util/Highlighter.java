...
public class Highlighter {
	...
	public static void getcolor(WebDriver driver, WebElement element, String color) {// OOPs ==> Polymorphism ==>
																						// Compile time
		// poly
	...
	public static void getcolor(WebDriver driver, WebElement element, String bgcolor, String fgcolor) {
		JavascriptExecutor js = (JavascriptExecutor) driver;
		js.executeScript(
				"arguments[0].setAttribute('style', 'background: " + bgcolor + "; border: 6px solid" + fgcolor + ";');",
				element);
