...
public class HomeSelection {
	public static void selectProperty(WebDriver driver) throws Throwable {
		...
		Highlighter.getcolor(driver, pfy.getLocationName(), "green", "red");
		...
		Highlighter.getcolor(driver, pfy.getMyZooplaBtn(), "green", "red");
		ScreenShot.getScreenShot(driver, "Log Out");

		Highlighter.getcolor(driver, pfy.getSignOutBtn(), "green", "red");
